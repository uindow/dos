...
This product includes software developed by Uindow™. Copyright © 2026, [Uindow™](https://uindow.com).

Licensed under the **Uindow™ Source-Available License**, version 1.0 (the "License").

You may obtain a copy of the License at:

    https://github.com/uindow/dos/blob/main/LICENSE.txt
...
This product uses third party software in accordance with their respective licenses:
  ...
  * **[js-yaml](https://npmjs.com/package/js-yaml)** `v.4.1.1` ⚖️ license: [MIT](./lic/js-yaml.license.md) • author: Vladimir Zapparov <dervus.grim@gmail.com>
  ...
  * 🖌️ **[Font: Caveat](https://fonts.google.com/specimen/Caveat)** `v.1.500` ⚖️ license: [OFL-1.1](./lic/@font-caveat.license.md) • author: The Caveat Project Authors (https://github.com/googlefonts/caveat)
  * 🖌️ **[Font: ComicRelief](https://fonts.google.com/specimen/ComicRelief)** `v.1.210` ⚖️ license: [OFL-1.1](./lic/@font-comicrelief.license.md) • author: The Comic Relief Project Authors (https://github.com/loudifier/Comic-Relief)
  * 🖌️ **[Font: DancingScript](https://fonts.google.com/specimen/DancingScript)** `v.2.000` ⚖️ license: [OFL-1.1](./lic/@font-dancingscript.license.md) • author: The Dancing Script Project Authors (https://github.com/googlefonts/DancingScript)
  * 🖌️ **[Font: HennyPenny](https://fonts.google.com/specimen/HennyPenny)** `v.1.0` ⚖️ license: [OFL-1.1](./lic/@font-hennypenny.license.md) • author: BrownFox (gayaneh.b@gmail.com|www.brownfox.org)
  ...
  * 🖌️ **[Font: LibreBaskerville](https://fonts.google.com/specimen/LibreBaskerville)** `v.2.004` ⚖️ license: [OFL-1.1](./lic/@font-librebaskerville.license.md) • author: The Libre Baskerville Project Authors (https://github.com/impallari/Libre-Baskerville)
  * 🖌️ **[Font: Mansalva](https://fonts.google.com/specimen/Mansalva)** `v.1.0` ⚖️ license: [OFL-1.1](./lic/@font-mansalva.license.md) • author: The Mansalva Project Authors (https://github.com/carolinashort/mansalva)
  * 🖌️ **[Font: Pacifico](https://fonts.google.com/specimen/Pacifico)** `v.3.000` ⚖️ license: [OFL-1.1](./lic/@font-pacifico.license.md) • author: The Pacifico Project Authors (https://github.com/googlefonts/Pacifico)
  * 🖌️ **[Font: PermanentMarker](https://fonts.google.com/specimen/PermanentMarker)** `v.1.0` ⚖️ license: [Apache-2.0](./lic/@font-permanentmarker.license.md) • author: The Permanent Marker font family authors
  * 🖌️ **[Font: Rancho](https://fonts.google.com/specimen/Rancho)** `v.1.0` ⚖️ license: [Apache-2.0](./lic/@font-rancho.license.md) • author: The Rancho Project Authors
  * 🖌️ **[Font: Satisfy](https://fonts.google.com/specimen/Satisfy)** `v.1.0` ⚖️ license: [Apache-2.0](./lic/@font-satisfy.license.md) • author: The Satisfy font family authors
